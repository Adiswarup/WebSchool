...
namespace WebCat7.Data
{
    public partial class SchContext : DbContext
    {
        ...
        //public virtual DbSet<PermissionT1> PermissionT1 { get; set; }
        ...
        //public virtual DbSet<RemindMe> RemindMe { get; set; }
        ...
        //public virtual DbSet<SubsTeach> SubsTeach { get; set; }
...
//ACCTECH\SQLEXPRESSWEB16
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    entity.Property(e => e.ClssName).HasMaxLength(50);
            ...
            //modelBuilder.Entity<PermissionT1>(entity =>
            //{
            //    entity.HasKey(e => e.AutoId)
            //        .HasName("PK__PermissionT_1__6EAB62A3");

            //    entity.ToTable("PermissionT_1");
            ...
            //    entity.Property(e => e.BoardNo).HasColumnType("ntext");

            //    entity.Property(e => e.BusRoute).HasColumnType("ntext");
            ...
            //    entity.Property(e => e.EmailAddress).HasColumnType("ntext");
            ...
            //    entity.Property(e => e.Lgaddress1)
            //        .HasColumnName("LGAddress1")
            //        .HasColumnType("ntext");

            //    entity.Property(e => e.Lgaddress2)
            ...
            //    entity.Property(e => e.OralHygiene).HasColumnType("ntext");

            //    entity.Property(e => e.ParentsNamesF).HasMaxLength(255);

            //    entity.Property(e => e.ParentsNamesM).HasMaxLength(255);

            //    entity.Property(e => e.PermAddress).HasColumnType("ntext");

            //    entity.Property(e => e.PermAddress1).HasColumnType("ntext");

            //    entity.Property(e => e.PermAilment).HasColumnType("ntext");

            //    entity.Property(e => e.PermCity).HasMaxLength(255);

            //    entity.Property(e => e.PermIdentification).HasColumnType("ntext");
            ...
            //    entity.Property(e => e.QualificationF).HasColumnType("ntext");
            ...
            //    entity.Property(e => e.SplAilment).HasColumnType("ntext");
            ...
            //    entity.Property(e => e.Teeth).HasColumnType("ntext");

            //    entity.Property(e => e.Testimonials).HasMaxLength(255);

            //    entity.Property(e => e.VisionL).HasColumnType("ntext");

            //    entity.Property(e => e.VisionR).HasColumnType("ntext");
            //});
            ...
            //modelBuilder.Entity<RemindMe>(entity =>
            //{
            //    entity.HasKey(e => e.AutoId)
            //        .HasName("PK_RemindMe");
            ...
            //{
            //    entity.HasKey(e => e.AutoId)
            //        .HasName("PK__Roles_1__69E6AD86");

            //    entity.ToTable("Roles_1");
            ...
            //    entity.Property(e => e.ConveyanceMode).HasMaxLength(50);
            ...
            //    entity.Property(e => e.PrefTeacher).HasColumnName("Pref_Teacher");
            ...
            //modelBuilder.Entity<SubsTeach>(entity =>
            //{
            //    entity.HasKey(e => e.AutoId)
            //        .HasName("PK_SubsTeach");
            ...
            //    entity.Property(e => e.SubsTeachId)
            //        .HasColumnName("SubsTeachID")
            //        .HasDefaultValueSql("0");
            //});
            ...
            //    entity.Property(e => e.VehicleType1).HasColumnName("VehicleType");
        ...
        //public DbSet<WebCat7.Models.ViewModel.ClssVM> ClssVM { get; set; }

        public DbSet<SchMod.Models.Studs.SearchStd> SearchStd { get; set; }

        public DbSet<SchMod.Models.General.AccountHead> AccountHead { get; set; }

        public DbSet<SchMod.Models.Basics.StdHouse> StdHouse { get; set; }

        public DbSet<SchMod.Models.Basics.StdCat> StdCat { get; set; }
        public DbSet<SchMod.Models.StdFees.StdFeeCat> StdFeeCat { get; set; }

        public DbSet<SchMod.Models.Basics.Subjects> Subjects { get; set; }
        public DbSet<SchMod.ViewModels.StdFees.FeeForm> FeeForm { get; set; }
        public DbSet<SchMod.Models.Active.ActivityGroup> ActivityGroup { get; set; }
        public DbSet<SchMod.Models.Active.Activity> Activity { get; set; }
        public DbSet<SchMod.Models.Active.ActiLog> ActiLog { get; set; }
        public DbSet<SchMod.Models.Active.Attendance> Attendance { get; set; }
        public DbSet<SchMod.Models.Convey.VehicleType> VehicleType { get; set; }
        public DbSet<SchMod.Models.Convey.VehicleDescription> VehicleDescription { get; set; }
        public DbSet<SchMod.Models.Convey.Stops> Stops { get; set; }
        public DbSet<SchMod.Models.Convey.Conveyance> Conveyance { get; set; }
