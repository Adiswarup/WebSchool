...
namespace SchDataApi.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public RolesController(SchContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> GetRoles([FromRoute] int id)
        {
            ...
            var roles = await _context.Roles.SingleOrDefaultAsync(m => m.AutoId == id);
        ...
        public async Task<IActionResult> PostRoles([FromBody] Roles roles)
        {
            ...
            return CreatedAtAction("GetRoles", new { id = roles.AutoId }, roles);
        }
        ...
        {
            return _context.Roles.Any(e => e.AutoId == id);
        }
    }
}