...
namespace SchDataApi.Controllers
{
    ...
    public class ActiLogsController : Controller
    {
        ...
        // GET: api/Activities
        [HttpGet]
        public IEnumerable<ActiLog> Get(int mdBID)
        {
            List<ActiLog> actiLogList = new List<ActiLog>();
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetActiLog([FromRoute] int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutActiLog([FromRoute] int id, [FromBody] Activity activity)
        {
        ...
        // POST: api/Activities
        [HttpPost]
        public async Task<IActionResult> PostActiLog([FromBody] Activity activity)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteActiLog([FromRoute] int id)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
